...
segmenter_model = load_model("/opt/tensorflow/syntaxnet/examples/dragnn/data/br/segmenter", "spec.textproto", "checkpoint")
parser_model = load_model("/opt/tensorflow/syntaxnet/examples/dragnn/data/br", "parser_spec.textproto", "checkpoint")
...
if __name__ == '__main__':
    a, b = annotate_text(' '.join(sys.argv[1:]))
    print a
